...
<script setup>
    ...
    const options = [
        { key: "Đang hoạt động", name: "Đang hoạt động" },
        { key: "Dừng hoạt động", name: "Dừng hoạt động" },
        { key: "Tạm dừng hoạt động", name: "Tạm dừng hoạt động" },
        { key: "Khóa tài khoản", name: "Khóa tài khoản" },
    ]

    // ✅ Gán giá trị mặc định nếu chưa có
    const internalValue = ref(props.modelField || options[0]?.name || '')
